...
var app = (function () {
    ...
    const file$4 = "src/ContactCard.svelte";
    ...
    */
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*checkAnswer*/ ctx[9](/*q*/ ctx[13][0], /*randomQuestion*/ ctx[3]["answer"][0]))) /*checkAnswer*/ ctx[9](/*q*/ ctx[13][0], /*randomQuestion*/ ctx[3]["answer"][0]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*randomQuestion*/ 8 && li_gender_value !== (li_gender_value = /*q*/ ctx[13][1])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<QuizModal> was created with unknown prop '${key}'`);
    	});
    ...
    class QuizModal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { gerund: 0, trans: 1 });
    		...
    		if (/*gerund*/ ctx[0] === undefined && !('gerund' in props)) {
    			console_1$1.warn("<QuizModal> was created without expected prop 'gerund'");
    		}

    		if (/*trans*/ ctx[1] === undefined && !('trans' in props)) {
    			console_1$1.warn("<QuizModal> was created without expected prop 'trans'");
    		}
    	}
