...
var app = (function () {
    ...
    */
    ...
    // (81:12) {#each shuffle(randomQuestion["test"]) as q, i}
    function create_each_block(ctx) {
    	let li;
    	let raw_value = /*q*/ ctx[12] + "";
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			add_location(li, file$1, 81, 16, 2191);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*checkAnswer*/ ctx[8](/*q*/ ctx[12], /*randomQuestion*/ ctx[3]["answer"]))) /*checkAnswer*/ ctx[8](/*q*/ ctx[12], /*randomQuestion*/ ctx[3]["answer"]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*randomQuestion*/ 8 && raw_value !== (raw_value = /*q*/ ctx[12] + "")) li.innerHTML = raw_value;		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(81:12) {#each shuffle(randomQuestion[\\\"test\\\"]) as q, i}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$1, 71, 4, 1810);
    			attr_dev(span, "aria-hidden", "true");
    			add_location(span, file$1, 73, 8, 1948);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "close");
    			add_location(button0, file$1, 72, 8, 1869);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$1, 70, 4, 1779);
    			html_tag.a = t6;
    			add_location(hr0, file$1, 78, 8, 2097);
    			add_location(ul, file$1, 79, 8, 2110);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$1, 76, 4, 2021);
    			add_location(hr1, file$1, 86, 4, 2314);
    			add_location(p0, file$1, 87, 4, 2323);
    			add_location(p1, file$1, 88, 4, 2353);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-primary");
    			add_location(button1, file$1, 90, 8, 2422);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$1, 89, 4, 2387);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*randomizer*/ ctx[7], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*checkAnswer, shuffle, randomQuestion*/ 264) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(70:0) <Modal bind:open={isOpen}>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 94, 0, 2531);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*openQuiz*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, incorrect, correct, randomQuestion, isOpen, trans, gerund*/ 32831) {
    ...
    function create_fragment(ctx) {
    	...
    	let small10;
    	let t95;
    	let t96_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t96;
    	let t97;
    	let t98;
    	let p10;
    	...
    	let small11;
    	let t104;
    	let t105_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t105;
    	let t106;
    	let p11;
    	let u3;
    	...
    	let small12;
    	let t113;
    	let t114_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t114;
    	let t115;
    	let p12;
    	let t116;
    	...
    	let small13;
    	let t121;
    	let t122_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t122;
    	let t123;
    	let p13;
    	let u4;
    	...
    	let small14;
    	let t130;
    	let t131_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t131;
    	let t132;
    	let t133;
    	let p14;
    	...
    	let small15;
    	let t139;
    	let t140_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t140;
    	let t141;
    	let t142;
    	let p15;
    	...
    	let article16;
    	let small16;
    	let t149_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t149;
    	let t150;
    	let t151;
    	let p16;
    	...
    	let small17;
    	let t156;
    	let t157_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t157;
    	let t158;
    	let t159;
    	let p17;
    	...
    	let article18;
    	let small18;
    	let t164_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t164;
    	let t165;
    	let t166;
    	let p18;
    	...
    	let small19;
    	let t171;
    	let t172_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t172;
    	let t173;
    	let t174;
    	let p19;
    	...
    	let small20;
    	let t179;
    	let t180_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t180;
    	let t181;
    	let t182;
    	let p20;
    	...
    	let small21;
    	let t188;
    	let t189_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t189;
    	let t190;
    	let t191;
    	let p21;
    	...
    	let small22;
    	let t197;
    	let t198_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t198;
    	let t199;
    	let t200;
    	let p22;
    	...
    	let small23;
    	let t206;
    	let t207_value = /*trans*/ ctx[1].split("ing")[0] + "";
    	let t207;
    	let t208;
    	let t209;
    	let p23;
    	...
    	const block = {
    		c: function create() {
    			...
    			t23 = text("You are ");
    			t24 = text(/*trans*/ ctx[1]);
    			t25 = text(" (informal)");
    			t26 = space();
    			p2 = element("p");
    			t27 = text("Tum ");
    			b2 = element("b");
    			t28 = text(/*bones*/ ctx[2]);
    			t29 = text("rahey ho");
    			t30 = space();
    			hr3 = element("hr");
    			t31 = space();
    			...
    			t32 = text("You are ");
    			t33 = text(/*trans*/ ctx[1]);
    			t34 = text(" (formal)");
    			t35 = space();
    			p3 = element("p");
    			t36 = text("Aap ");
    			b3 = element("b");
    			t37 = text(/*bones*/ ctx[2]);
    			t38 = text("rahey hein");
    			t39 = space();
    			hr4 = element("hr");
    			t40 = space();
    			...
    			t41 = text("I'm ");
    			t42 = text(/*trans*/ ctx[1]);
    			t43 = space();
    			p4 = element("p");
    			t44 = text("Mein ");
    			b4 = element("b");
    			t45 = text(/*bones*/ ctx[2]);
    			t46 = text("rahee hun");
    			t47 = space();
    			hr5 = element("hr");
    			t48 = space();
    			...
    			t58 = text("You are ");
    			t59 = text(/*trans*/ ctx[1]);
    			t60 = text(" (informal)");
    			t61 = space();
    			p6 = element("p");
    			t62 = text("Tum ");
    			b6 = element("b");
    			t63 = text(/*bones*/ ctx[2]);
    			t64 = text("rahee ho");
    			t65 = space();
    			hr7 = element("hr");
    			t66 = space();
    			...
    			t67 = text("You are ");
    			t68 = text(/*trans*/ ctx[1]);
    			t69 = text(" (formal)");
    			t70 = space();
    			p7 = element("p");
    			t71 = text("Aap ");
    			b7 = element("b");
    			t72 = text(/*bones*/ ctx[2]);
    			t73 = text("raheen hein");
    			t74 = space();
    			hr8 = element("hr");
    			t75 = space();
    			...
    			t76 = text("We're ");
    			t77 = text(/*trans*/ ctx[1]);
    			t78 = text(" (neutral)");
    			t79 = space();
    			p8 = element("p");
    			t80 = text("Hum ");
    			b8 = element("b");
    			t81 = text(/*bones*/ ctx[2]);
    			t82 = text("rahey hein");
    			t83 = space();
    			hr9 = element("hr");
    			t84 = space();
    			...
    			t85 = text("They're ");
    			t86 = text(/*trans*/ ctx[1]);
    			t87 = text(" (they/formal neutral)");
    			t88 = space();
    			p9 = element("p");
    			u2 = element("u");
    			u2.textContent = "Woh";
    			...
    			t139 = text("They/He will ");
    			t140 = text(t140_value);
    			t141 = text(" (they/formal neutral)");
    			t142 = space();
    			p15 = element("p");
    			u5 = element("u");
    			u5.textContent = "Woh";
    			...
    			t150 = text("! (informal neutral)");
    			t151 = space();
    			p16 = element("p");
    			b16 = element("b");
    			t152 = text(/*bones*/ ctx[2]);
    			t153 = text("o!");
    			t154 = space();
    			hr17 = element("hr");
    			t155 = space();
    			...
    			t158 = text("! (informal neutral)");
    			t159 = space();
    			p17 = element("p");
    			b17 = element("b");
    			t160 = text(/*bones*/ ctx[2]);
    			t161 = text("ein!");
    			t162 = space();
    			hr18 = element("hr");
    			t163 = space();
    			...
    			t165 = text("! (formal neutral)");
    			t166 = space();
    			p18 = element("p");
    			b18 = element("b");
    			t167 = text(/*bones*/ ctx[2]);
    			t168 = text("ein!");
    			t169 = space();
    			hr19 = element("hr");
    			t170 = space();
    			...
    			t173 = text("! (formal neutral)");
    			t174 = space();
    			p19 = element("p");
    			b19 = element("b");
    			t175 = text(/*bones*/ ctx[2]);
    			t176 = text("ein!");
    			t177 = space();
    			hr20 = element("hr");
    			t178 = space();
    			...
    			add_location(label, file, 52, 4, 834);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "gerund");
    			attr_dev(input0, "placeholder", "Gerund");
    			add_location(input0, file, 53, 4, 873);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "trans");
    			attr_dev(input1, "placeholder", "Translation");
    			add_location(input1, file, 54, 4, 952);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file, 51, 2, 803);
    			add_location(hr0, file, 57, 2, 1044);
    			attr_dev(small0, "class", "svelte-azb90x");
    			add_location(small0, file, 62, 2, 1134);
    			add_location(b0, file, 63, 10, 1171);
    			add_location(p0, file, 63, 2, 1163);
    			add_location(hr1, file, 64, 2, 1202);
    			attr_dev(article0, "class", "masc svelte-azb90x");
    			add_location(article0, file, 61, 0, 1109);
    			attr_dev(small1, "class", "svelte-azb90x");
    			add_location(small1, file, 68, 2, 1244);
    			add_location(u0, file, 69, 5, 1280);
    			add_location(b1, file, 69, 16, 1291);
    			add_location(p1, file, 69, 2, 1277);
    			add_location(hr2, file, 70, 2, 1321);
    			attr_dev(article1, "class", "masc svelte-azb90x");
    			add_location(article1, file, 67, 0, 1219);
    			attr_dev(small2, "class", "svelte-azb90x");
    			add_location(small2, file, 74, 2, 1363);
    			add_location(b2, file, 75, 9, 1415);
    			add_location(p2, file, 75, 2, 1408);
    			add_location(hr3, file, 76, 2, 1445);
    			attr_dev(article2, "class", "masc svelte-azb90x");
    			add_location(article2, file, 73, 0, 1338);
    			attr_dev(small3, "class", "svelte-azb90x");
    			add_location(small3, file, 81, 2, 1488);
    			add_location(b3, file, 82, 9, 1538);
    			add_location(p3, file, 82, 2, 1531);
    			add_location(hr4, file, 83, 2, 1570);
    			attr_dev(article3, "class", "masc svelte-azb90x");
    			add_location(article3, file, 80, 0, 1463);
    			attr_dev(small4, "class", "svelte-azb90x");
    			add_location(small4, file, 88, 2, 1612);
    			add_location(b4, file, 89, 10, 1649);
    			add_location(p4, file, 89, 2, 1641);
    			add_location(hr5, file, 90, 2, 1680);
    			attr_dev(article4, "class", "fem svelte-azb90x");
    			add_location(article4, file, 87, 0, 1588);
    			attr_dev(small5, "class", "svelte-azb90x");
    			add_location(small5, file, 94, 2, 1721);
    			add_location(u1, file, 95, 5, 1757);
    			add_location(b5, file, 95, 16, 1768);
    			add_location(p5, file, 95, 2, 1754);
    			add_location(hr6, file, 96, 2, 1798);
    			attr_dev(article5, "class", "fem svelte-azb90x");
    			add_location(article5, file, 93, 0, 1697);
    			attr_dev(small6, "class", "svelte-azb90x");
    			add_location(small6, file, 100, 2, 1839);
    			add_location(b6, file, 101, 9, 1891);
    			add_location(p6, file, 101, 2, 1884);
    			add_location(hr7, file, 102, 2, 1921);
    			attr_dev(article6, "class", "fem svelte-azb90x");
    			add_location(article6, file, 99, 0, 1815);
    			attr_dev(small7, "class", "svelte-azb90x");
    			add_location(small7, file, 106, 2, 1962);
    			add_location(b7, file, 107, 9, 2012);
    			add_location(p7, file, 107, 2, 2005);
    			add_location(hr8, file, 108, 2, 2045);
    			attr_dev(article7, "class", "fem svelte-azb90x");
    			add_location(article7, file, 105, 0, 1938);
    			attr_dev(small8, "class", "neutral");
    			add_location(small8, file, 112, 2, 2074);
    			add_location(b8, file, 113, 9, 2138);
    			add_location(p8, file, 113, 2, 2131);
    			add_location(hr9, file, 114, 2, 2170);
    			add_location(article8, file, 111, 0, 2062);
    			add_location(small9, file, 119, 2, 2200);
    			add_location(u2, file, 120, 5, 2258);
    			add_location(b9, file, 120, 16, 2269);
    			add_location(p9, file, 120, 2, 2255);
    			add_location(hr10, file, 121, 2, 2301);
    			add_location(article9, file, 118, 0, 2188);
    			attr_dev(small10, "class", "svelte-azb90x");
    			add_location(small10, file, 126, 2, 2344);
    			add_location(b10, file, 127, 10, 2407);
    			add_location(p10, file, 127, 2, 2399);
    			add_location(hr11, file, 128, 2, 2432);
    			attr_dev(article10, "class", "masc svelte-azb90x");
    			add_location(article10, file, 125, 0, 2319);
    			attr_dev(small11, "class", "svelte-azb90x");
    			add_location(small11, file, 132, 2, 2474);
    			add_location(u3, file, 133, 5, 2526);
    			add_location(b11, file, 133, 16, 2537);
    			add_location(p11, file, 133, 2, 2523);
    			add_location(hr12, file, 134, 2, 2562);
    			attr_dev(article11, "class", "masc svelte-azb90x");
    			add_location(article11, file, 131, 0, 2449);
    			attr_dev(small12, "class", "svelte-azb90x");
    			add_location(small12, file, 138, 2, 2603);
    			add_location(b12, file, 139, 10, 2659);
    			add_location(p12, file, 139, 2, 2651);
    			add_location(hr13, file, 140, 2, 2684);
    			attr_dev(article12, "class", "fem svelte-azb90x");
    			add_location(article12, file, 137, 0, 2579);
    			attr_dev(small13, "class", "svelte-azb90x");
    			add_location(small13, file, 144, 2, 2725);
    			add_location(u4, file, 145, 5, 2778);
    			add_location(b13, file, 145, 16, 2789);
    			add_location(p13, file, 145, 2, 2775);
    			add_location(hr14, file, 146, 2, 2814);
    			attr_dev(article13, "class", "fem svelte-azb90x");
    			add_location(article13, file, 143, 0, 2701);
    			add_location(small14, file, 151, 2, 2844);
    			add_location(b14, file, 152, 9, 2910);
    			add_location(p14, file, 152, 2, 2903);
    			add_location(hr15, file, 153, 2, 2937);
    			add_location(article14, file, 150, 0, 2832);
    			add_location(small15, file, 157, 2, 2966);
    			add_location(u5, file, 158, 5, 3045);
    			add_location(b15, file, 158, 16, 3056);
    			add_location(p15, file, 158, 2, 3042);
    			add_location(hr16, file, 159, 2, 3083);
    			add_location(article15, file, 156, 0, 2954);
    			add_location(small16, file, 164, 2, 3113);
    			add_location(b16, file, 165, 5, 3177);
    			add_location(p16, file, 165, 2, 3174);
    			add_location(hr17, file, 166, 2, 3200);
    			add_location(article16, file, 163, 0, 3101);
    			add_location(small17, file, 170, 2, 3229);
    			add_location(b17, file, 171, 5, 3300);
    			add_location(p17, file, 171, 2, 3297);
    			add_location(hr18, file, 172, 2, 3325);
    			add_location(article17, file, 169, 0, 3217);
    			add_location(small18, file, 176, 2, 3354);
    			add_location(b18, file, 177, 5, 3416);
    			add_location(p18, file, 177, 2, 3413);
    			add_location(hr19, file, 178, 2, 3441);
    			add_location(article18, file, 175, 0, 3342);
    			add_location(small19, file, 182, 2, 3470);
    			add_location(b19, file, 183, 5, 3539);
    			add_location(p19, file, 183, 2, 3536);
    			add_location(hr20, file, 184, 2, 3564);
    			add_location(article19, file, 181, 0, 3458);
    			attr_dev(small20, "class", "svelte-azb90x");
    			add_location(small20, file, 188, 2, 3606);
    			add_location(b20, file, 189, 9, 3675);
    			add_location(p20, file, 189, 2, 3668);
    			add_location(hr21, file, 190, 2, 3701);
    			attr_dev(article20, "class", "masc svelte-azb90x");
    			add_location(article20, file, 187, 0, 3581);
    			attr_dev(small21, "class", "svelte-azb90x");
    			add_location(small21, file, 194, 2, 3743);
    			add_location(b21, file, 195, 9, 3810);
    			add_location(p21, file, 195, 2, 3803);
    			add_location(hr22, file, 196, 2, 3838);
    			attr_dev(article21, "class", "masc svelte-azb90x");
    			add_location(article21, file, 193, 0, 3718);
    			attr_dev(small22, "class", "svelte-azb90x");
    			add_location(small22, file, 201, 2, 3880);
    			add_location(b22, file, 202, 9, 3949);
    			add_location(p22, file, 202, 2, 3942);
    			add_location(hr23, file, 203, 2, 3974);
    			attr_dev(article22, "class", "fem svelte-azb90x");
    			add_location(article22, file, 200, 0, 3856);
    			attr_dev(small23, "class", "svelte-azb90x");
    			add_location(small23, file, 207, 2, 4015);
    			add_location(b23, file, 208, 9, 4082);
    			add_location(p23, file, 208, 2, 4075);
    			add_location(hr24, file, 209, 2, 4110);
    			attr_dev(article23, "class", "fem svelte-azb90x");
    			add_location(article23, file, 206, 0, 3991);
    			attr_dev(div1, "id", "form");
    			attr_dev(div1, "class", "svelte-azb90x");
    			add_location(div1, file, 50, 0, 785);
    			add_location(br, file, 214, 0, 4135);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(small3, t32);
    			append_dev(small3, t33);
    			append_dev(small3, t34);
    			append_dev(article3, t35);
    			...
    			append_dev(small5, t49);
    			append_dev(small5, t50);
    			append_dev(article5, t51);
    			...
    			append_dev(small9, t85);
    			append_dev(small9, t86);
    			append_dev(small9, t87);
    			append_dev(article9, t88);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t7, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t10, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t15, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t19, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t24, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t28, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t33, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t37, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t42, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t45, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t50, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t54, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t59, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t63, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t68, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t72, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t77, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t81, /*bones*/ ctx[2]);
    			if (!current || dirty & /*trans*/ 2) set_data_dev(t86, /*trans*/ ctx[1]);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t91, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t96_value !== (t96_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t96, t96_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t100, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t105_value !== (t105_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t105, t105_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t109, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t114_value !== (t114_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t114, t114_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t117, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t122_value !== (t122_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t122, t122_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t126, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t131_value !== (t131_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t131, t131_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t135, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t140_value !== (t140_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t140, t140_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t145, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t149_value !== (t149_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t149, t149_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t152, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t157_value !== (t157_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t157, t157_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t160, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t164_value !== (t164_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t164, t164_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t167, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t172_value !== (t172_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t172, t172_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t175, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t180_value !== (t180_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t180, t180_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t184, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t189_value !== (t189_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t189, t189_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t193, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t198_value !== (t198_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t198, t198_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t202, /*bones*/ ctx[2]);
    			if ((!current || dirty & /*trans*/ 2) && t207_value !== (t207_value = /*trans*/ ctx[1].split("ing")[0] + "")) set_data_dev(t207, t207_value);
    			if (!current || dirty & /*bones*/ 4) set_data_dev(t211, /*bones*/ ctx[2]);
    		},
    		i: function intro(local) {
    			if (current) return;
